  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      for (let i = 0; i < cells.length; i++) {
        ...
        cells[i].style.background = `rgba(124,58,237,${opacity.toFixed(3)})`;
      }
    ...
    <section id="features" style={{ position: "relative", maxWidth: "72rem", margin: "0 auto", padding: "7rem 1.5rem" }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "1.5rem", marginBottom: "3rem" }}>
        <div className="reveal-left">
          <div className="font-mono" style={{ fontSize: "0.7rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#7C3AED" }}>— {T.features.label}</div>
      ...
      <div style={{ display: "grid", gap: "1.25rem" }} className="stagger">
        ...
        <div className="bento reveal" style={{ borderRadius: "1rem", padding: "1.75rem", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ width: "3rem", height: "3rem", borderRadius: "0.75rem", border: "1px solid rgba(124,58,237,0.4)", background: "rgba(124,58,237,0.1)", display: "grid", placeItems: "center", color: "#7C3AED" }}>
          ...
          <div ref={heatmapRef} style={{ marginTop: "2rem", display: "grid", gridTemplateColumns: "repeat(24, 1fr)", gap: "3px" }}>
            {Array.from({ length: 168 }).map((_, i) => (
              <div key={i} style={{ height: "10px", borderRadius: "2px", background: `rgba(124,58,237,${(0.08 + ((Math.sin(i * 0.7 + 1.3) + 1) / 2) * 0.72).toFixed(3)})`, transition: "background 0.6s ease" }} />
            ))}
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.25rem" }}>
          ...
          <div className="bento reveal" style={{ borderRadius: "1rem", padding: "1.75rem" }}>
            ...
            <div style={{ marginTop: "1.25rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <span className="font-mono" style={{ fontSize: "0.75rem", color: "var(--text-secondary)" }}>QUALITY</span>
              <div style={{ flex: 1, height: "0.375rem", borderRadius: "9999px", background: "rgba(0,0,0,0.06)", overflow: "hidden" }}>
                <div style={{ height: "100%", width: "94%", background: "#7C3AED", borderRadius: "9999px" }} />
              </div>
              <span className="font-mono" style={{ fontSize: "0.75rem" }}>94%</span>
            </div>
          </div>
          ...
          <div className="bento reveal" style={{ borderRadius: "1rem", padding: "1.75rem" }}>
            ...
            <div style={{ marginTop: "1.25rem", display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
              {["YouTube", "TikTok", "Instagram", "LinkedIn"].map((b) => (
              ...
              <span className="font-mono" style={{ fontSize: "0.6875rem", padding: "0.25rem 0.625rem", borderRadius: "9999px", border: "1px solid rgba(124,58,237,0.4)", color: "#7C3AED" }}>+23 more</span>
            </div>
          </div>
        </div>
      </div>
