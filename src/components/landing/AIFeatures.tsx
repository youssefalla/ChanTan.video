      ...
      <div style={{ maxWidth: "72rem", margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "1.5rem", marginBottom: "3rem" }}>
          <div className="reveal-left">
            <div className="font-mono" style={{ fontSize: "0.7rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#7C3AED" }}>— {T.aiFeatures.label}</div>
            ...
            <div className="ai-content" style={{ display: "grid", gridTemplateColumns: "1fr", gap: "2rem", padding: "2rem 2.5rem", alignItems: "center" }}>
              <div style={{ display: "grid", gap: "2rem", alignItems: "center" }} className="md:grid-cols-2">
                <div>
                  ...
                  <div className="font-mono" style={{ marginTop: "1.5rem", display: "inline-flex", alignItems: "center", gap: "0.5rem", fontSize: "0.6875rem", textTransform: "uppercase", letterSpacing: "0.12em", color: "#7C3AED" }}>
                    <span style={{ width: "0.375rem", height: "0.375rem", borderRadius: "9999px", background: "#7C3AED", animation: "digit-pulse 1.6s ease-in-out infinite" }} />
                    Live · 247 frames/min
                  </div>
                </div>
                ...
                <div className="ai-mock floaty" style={{ padding: "1.25rem" }}>
                  <div className="font-mono" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: "0.6875rem" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "var(--text-secondary)" }}>
                      <span style={{ width: "0.375rem", height: "0.375rem", borderRadius: "9999px", background: "#7C3AED" }} />
                      <span>My project</span>
                      <span style={{ color: "var(--text-secondary)", opacity: 0.4 }}>/</span>
                      <span style={{ color: "var(--text-secondary)", opacity: 0.6 }}>CanTan Studio 2026</span>
                    </div>
                    <div style={{ width: "3rem", height: "1.25rem", borderRadius: "9999px", background: "rgba(10,10,10,0.06)", border: "1px solid rgba(10,10,10,0.08)", display: "flex", alignItems: "center", justifyContent: "flex-end", paddingRight: "0.125rem" }}>
                      <span style={{ width: "1rem", height: "1rem", borderRadius: "9999px", background: "#7C3AED" }} />
                    </div>
                  </div>
                  <div style={{ color: "var(--text-primary)", fontSize: "0.875rem", marginTop: "1rem" }}>Cinematic travel vlog</div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem", marginTop: "0.75rem" }}>
                    {[["Color", "2/3"], ["Audio", "1/3"]].map(([label, w]) => (
                      <div key={label} className="ai-mock-input" style={{ padding: "0.75rem" }}>
                        ...
                        <div style={{ marginTop: "0.5rem", height: "0.375rem", borderRadius: "9999px", background: "rgba(10,10,10,0.07)" }}>
                          <div style={{ height: "100%", width: w === "2/3" ? "66%" : "33%", borderRadius: "9999px", background: "linear-gradient(90deg, #5B21B6, #7C3AED)" }} />
                        </div>
                      </div>
                    ))}
                  </div>
                  <div className="ai-mock-input" style={{ padding: "0.75rem", marginTop: "0.75rem" }}>
                    <div className="font-mono" style={{ fontSize: "0.625rem", color: "var(--text-secondary)", textTransform: "uppercase", letterSpacing: "0.1em" }}>AI Score</div>
            ...
            <div className="ai-card reveal" style={{ minHeight: "380px" }}>
              <div className="ai-content" style={{ height: "100%", padding: "1.75rem", display: "flex", flexDirection: "column" }}>
                <div style={{ flex: 1, display: "grid", placeItems: "center", position: "relative" }}>
                  <div style={{ position: "absolute", top: "0.5rem", left: "50%", transform: "translateX(-50%)", width: "2.25rem", height: "2.25rem", borderRadius: "9999px", background: "rgba(124,58,237,0.08)", border: "1px solid rgba(124,58,237,0.25)", display: "grid", placeItems: "center" }}>
                  ...
                  <span style={{ position: "absolute", top: "2.75rem", bottom: "2.75rem", left: "50%", transform: "translateX(-50%)", width: "1px", background: "linear-gradient(to bottom, rgba(124,58,237,0.4), rgba(124,58,237,0.15), rgba(124,58,237,0.4))" }} />
                  <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", zIndex: 1 }}>
                    {["0", "2", ":", "34"].map((k) => (
                      <span key={k} className="ai-key">{k}</span>
                    ))}
                  </div>
                  <div style={{ position: "absolute", bottom: "0.5rem", left: "50%", transform: "translateX(-50%)", width: "2.25rem", height: "2.25rem", borderRadius: "9999px", background: "rgba(124,58,237,0.08)", border: "1px solid rgba(124,58,237,0.25)", display: "grid", placeItems: "center" }}>
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1.5rem" }}>
                  <div className="floaty" style={{ position: "relative", width: "130px", height: "130px" }}>
                    <svg viewBox="0 0 140 140" style={{ width: "100%", height: "100%", transform: "rotate(-90deg)" }}>
                      <circle cx="70" cy="70" r="54" fill="none" stroke="rgba(124,58,237,0.12)" strokeWidth="9" />
                      <circle cx="70" cy="70" r="54" fill="none" stroke="#7C3AED" strokeWidth="9"
                        strokeLinecap="round" className="perf-ring" />
                    </svg>
                    <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                      <span className="font-display" style={{ fontSize: "2rem", lineHeight: 1, color: "var(--text-primary)" }}>94<span style={{ fontSize: "1rem", color: "#7C3AED" }}>%</span></span>
                      <span className="font-mono" style={{ fontSize: "0.55rem", textTransform: "uppercase", letterSpacing: "0.12em", color: "#7C3AED", marginTop: "0.3rem" }}>AI Score</span>
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: "1.5rem" }}>
                    {[["Retain", "87%"], ["Pacing", "A+"], ["Cuts", "47"]].map(([label, val]) => (
              ...
              <div className="ai-content" style={{ height: "100%", padding: "1.75rem", display: "flex", flexDirection: "column" }}>
                <div style={{ flex: 1, display: "grid", placeItems: "center" }}>
                  <div style={{ position: "relative", width: "240px", height: "200px" }}>
                    <div style={{ position: "absolute", left: "50%", top: "-0.25rem", transform: "translateX(-50%)", width: "2.75rem", height: "2.75rem", borderRadius: "9999px", background: "rgba(124,58,237,0.10)", border: "1px solid rgba(124,58,237,0.35)", display: "grid", placeItems: "center", color: "#7C3AED", zIndex: 10 }}>
                    ...
                    <div style={{ position: "absolute", left: "50%", bottom: "0.75rem", transform: "translateX(-50%)", width: "2.75rem", height: "2.75rem", borderRadius: "9999px", background: "rgba(124,58,237,0.10)", border: "1px solid rgba(124,58,237,0.35)", display: "grid", placeItems: "center", color: "#7C3AED", zIndex: 10 }}>
                    ...
                    <span style={{ position: "absolute", left: "50%", top: "50%", transform: "translate(-50%,-50%)", width: "0.5rem", height: "0.5rem", borderRadius: "9999px", background: "#7C3AED", boxShadow: "0 0 12px #7C3AED" }} />
                    <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }} viewBox="0 0 240 200" fill="none">
                      <defs>
                        <linearGradient id="arcG" x1="0" x2="1" y1="0" y2="0">
                          ...
                          <stop offset="50%" stopColor="#7C3AED" stopOpacity=".6" />
                      ...
                      <circle r="2.5" fill="#A78BFA" opacity=".8">
